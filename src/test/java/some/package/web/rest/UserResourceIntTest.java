package some.package.web.rest;

import some.package.ShoppingCartApplicationApp;
import some.package.domain.Authority;
import some.package.domain.User;
import some.package.repository.UserRepository;
import some.package.security.AuthoritiesConstants;
import some.package.service.MailService;
import some.package.service.UserService;
import some.package.service.dto.UserDTO;
import some.package.service.mapper.UserMapper;
import some.package.web.rest.errors.ExceptionTranslator;
import some.package.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = ShoppingCartApplicationApp.class)
